var map = L.map('map').setView([-6.914744, 107.609810], 13); // Koordinat awal Bandung
...
function searchLocation() {
    ...
    fetch(`https://nominatim.openstreetmap.org/search?format=json&q=${query}, Bandung, Indonesia`, {
        headers: {
